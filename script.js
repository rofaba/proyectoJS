...
function saludaUsuario() {
    alert(`Hola Pablo, hoy tengo algo nuevo que mostrarte`)
}
...
if (isNaN(letraMayus)){  //si no es un número, busca en cada index y agrega su posición a otro array 
    ...
    let posicionesParaUsuario = ubicaciones.map(function(suma){return suma +1}); //+1 para que usuario vea posiciones que conoce
